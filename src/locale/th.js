export default {
    ...
    toolbar: {
        ...
        strikethrough: 'ขีดทับ (Alt+Shift+5)',
        textColor: 'สีข้อความ',
        chooseColor: 'เลือกสี',
        resetColor: 'รีเซ็ต',
        customColor: 'กำหนดเอง',
        alternatingColors: 'สลับสี',
        confirmColor: 'ตกลง',
        cancelColor: 'ยกเลิก',
        collapse: 'ยุบ',
        fillColor: 'เติมสี',
        border: 'เส้นขอบ',
        borderStyle: 'รูปแบบเส้นขอบ',
        mergeCell: 'ผสานเซลล์',
        chooseMergeType: 'เลือกรูปแบบการผสาน',
        horizontalAlign: 'การจัดข้อความแนวนอน',
        verticalAlign: 'การจัดข้อความแนวตั้ง',
        alignment: 'การจัดข้อความ',
        textWrap: 'การตัดข้อความ',
        textWrapMode: 'โหมดการตัดข้อความ',
        textRotate: 'การหมุนข้อความ',
        textRotateMode: 'โหมดการหมุนข้อความ',
        freezeTopRow: 'Freeze top row',
        sortAndFilter: 'Sort and filter',
        findAndReplace: 'Find and replace',
        sum: 'SUM',
        autoSum: 'SUM อัตโนมัติ',
        moreFunction: 'ฟังก์ชั่นเพิ่มเติม',
    ...
    defaultFmt: [
        ...
        { "text": "", "value": "split", "example": "" },
        { "text": 'Date', "value": "dd/MM/yyyy", "example": "29/11/2017" },
        { "text": 'Time', "value": "hh:mm AM/PM", "example": "3:00 PM" },
        { "text": 'Time 24H', "value": "hh:mm", "example": "15:00" },
        { "text": 'Date time', "value": "dd/MM/yyyy hh:mm AM/PM", "example": "29/11/2017 3:00 PM" },
        { "text": 'Date time 24 H', "value": "dd/MM/yyyy hh:mm", "example": "29/11/2017 15:00" },
        { "text": "", "value": "split", "example": "" },
    ...
    border: {
        borderTop: 'ขอบด้านบน',
        borderBottom: 'ขอบด้านล่าง',
        borderLeft: 'ขอบด้านซ้าย',
        borderRight: 'ขอบด้านขวา',
        borderNone: 'ล้างขอบ',
        borderAll: 'ขอบทั้งหมด',
        borderOutside: 'ขอบรอบนอก',
        borderInside: 'ขอบด้านใน',
        borderHorizontal: 'ขอบแนวนอน',
        borderVertical: 'ขอบแนวตั้ง',
        borderColor: 'สีเส้นขอบ',
        borderSize: 'รูปแบบเส้นขอบ',
    },
    merge: {
        mergeAll: "ผสานทั้งหมด",
        mergeV: "ผสานแนวตั้ง",
        mergeH: "ผสานแนวนอน",
        mergeCancel: "ยกเลิกการผสาน",
        overlappingError: "ไม่สามารถผสานพื้นที่ทับซ้อนกันได้",
        partiallyError: "ไม่สามารถดำเนินการนี้ได้กับเซลล์ที่ถูกผสานไปบางส่วน",
    },
    align: {
        left: "ซ้าย",
        center: "กึ่งกลาง",
    ...
    textWrap: {
        "overflow": "ขึ้นต้นบรรทัดในเซลล์ใหม่",
        "wrap": "ตัดคำ",
        "clip": "ตัดออก",
    },
    rotation: {
    ...
    rightclick: {
        ...
        deleteSelectedColumn: 'ลบคอลัมน์ที่เลือก',
    ...
    drag: {
        noMerge: "ไม่สามารถดำเนินการนี้กับเซลล์ที่ถูกผสานได้",
        affectPivot: "This change cannot be made to the selected cell because it will affect the pivot table!",
        noMulti: "ไม่สามารถดำเนินการนี้ในพื้นที่การเลือกหลายพื้นที่โปรดเลือกพื้นที่เดียว",
        noPaste: "ไม่สามารถวางเนื้อหานี้ที่นี่ โปรดเลือกเซลล์ในพื้นที่วางแล้วลองวางอีกครั้ง",
        noPartMerge: "ไม่สามารถดำเนินการนี้กับเซลล์ที่ถูกผสานบางส่วน",

        inputCorrect: "โปรดป้อนค่าที่ถูกต้อง",
        notLessOne: "จำนวนแถวและคอลัมน์ต้องไม่น้อยกว่า 1",
        offsetColumnLessZero: "Offset ของคอลัมน์ต้องไม่เป็นค่าลบ",

        pasteMustKeybordAlert: "การคัดลอกและการวางในตาราง: Ctrl + C เพื่อคัดลอก, Ctrl + V เพื่อวาง, Ctrl + X เพื่อตัด",
        pasteMustKeybordAlertHTMLTitle: "การคัดลอกและการวางในตาราง",
        pasteMustKeybordAlertHTML: "<span style='line-height: 1.0;font-size:36px;font-weight: bold;color:#666;'>Ctrl + C</span>&nbsp;&nbsp;เพื่อคัดลอก<br/><span style='line-height: 1.0;font-size:36px;font-weight: bold;color:#666;'>Ctrl + V</span>&nbsp;&nbsp;เพื่อวาง<br/><span style='line-height: 1.0;font-size:36px;font-weight: bold;color:#666;'>Ctrl + X</span>&nbsp;&nbsp;เพื่อตัด",
    },
    pivotTable: {
        title: "Pivot Table",
        closePannel: "Close",
    ...
    dropCell: {
        copyCell: "คัดลอก",
        sequence: "เรียงลำดับ",
        onlyFormat: "เฉพาะรูปแบบ",
        noFormat: "ไม่เอารูปแบบ",
        day: "วัน",
        workDay: "วันทำงาน",
        month: "เดือน",
        year: "ปี",
